        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Insights and Decision Support</h4>
              <p>
                I work on data analytics and visualization projects that turn
                raw data into actionable insights for business and operational
                decision-making.
              </p>
